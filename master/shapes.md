...
non-zero values for the {{rx}} and {{ry}} geometric properties.</p>
...
attribute, the used value will be derived from the {{rx}} attribute.</p>
...
filled (see the {{fill}} property).</p>
...
equivalent {{path}} element as follows:</p>
...
{{viewBox}} attribute on the {{svg}} element.</p>
...
<p>An <a>SVGRectElement</a> object represents a {{rect}} element in the DOM.</p>
...
<a>reflect</a> the computed values of the {{x}}, {{y}},
...
<p>An <a>SVGCircleElement</a> object represents a {{circle}} element in the DOM.</p>
...
<a>reflect</a> the computed values of the {{cx}}, {{cy}}
...
<p>An <a>SVGEllipseElement</a> object represents a {{ellipse}} element in the DOM.</p>
...
The <a>SVGLineElement</a> interface corresponds to the {{line}}
element.
...
specification, so that they can be used to reflect {{polygon/points}} attributes.</p>
...
<p>An <a>SVGPolylineElement</a> object represents a {{polyline}} element in the DOM.</p>
...
<p>An <a>SVGPolygonElement</a> object represents a {{polygon}} element in the DOM.</p>
