...
<ul>
  <li>All appearance of [=SVGMatrix=] were replaced by [[geometry-1#DOMMatrix|DOMMatrix]] or [=DOMMatrixReadOnly=].</li>
...
<ul>
  ...
  <li>Deprecated the <a href="#linking-XLinkHrefAttribute">xlink:href</a> attribute in favor of using <span
