...
<ol>
  ...
  conversion of tile space to source space. This is used as a [[#TransformProperty|transform]] attribute of the element for the tile of the next step. </li>
  <li>Arrange each tile as a separate user coordinate system in SVG. For example,
  the tiles may be expressed a <{g}> elements
  with an [[#TransformProperty|transform]] attribute having the transformation matrix generated by the previous step.
